...
<!-- untuk menampilkan tanggal -->
	...
	<div align="center">
<table><td>
<form action="laporan_TiketPerTahun.php" name="laporan" id="laporan" method="post" enctype="multipart/form-data"><br>
<h2 align="center"><b><font face="Calibri">LAPORAN PENJUALAN TIKET<br>PER TAHUN</b> </h2>
		<div align="center"><b>PER TAHUN :</b>
		<select id="tahun_pesan" class="field select medium" tabindex="11" name="tahun_pesan" required> 
