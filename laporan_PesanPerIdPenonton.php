...
?>
  ...
  <table border="1"/>
   ...
   <h2><b><font face="Calibri">LAPORAN PEMESANAN TIKET<br>PER ID MEMBER <?php echo "$id_penonton" ?><br>TAHUN <?php echo "$tgl_pesan" ?></b> </h2></td></tr>
...
<?php
	...
	echo"</td></tr></table>";
	echo"<a href = print1.php?tgl_pesan=$tgl_pesan&id_penonton=$id_penonton>
